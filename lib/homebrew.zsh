...
#
#  Environment:	 HOMEBREW_API_AUTO_UPDATE_SECS HOMEBREW_API_DOMAIN HOMEBREW_ARCH HOMEBREW_AUTO_UPDATE_SECS
#		 HOMEBREW_BAT_CONFIG_PATH HOMEBREW_BAT_THEME HOMEBREW_BOTTLE_DOMAIN HOMEBREW_BREW_GIT_REMOTE
#		 HOMEBREW_BROWSER HOMEBREW_CACHE HOMEBREW_CASK_OPTS HOMEBREW_CELLAR HOMEBREW_CLEANUP_MAX_AGE_DAYS
#		 HOMEBREW_CLEANUP_PERIODIC_FULL_DAYS HOMEBREW_CORE_GIT_REMOTE HOMEBREW_CURL_PATH HOMEBREW_CURL_RETRIES
#		 HOMEBREW_DISPLAY HOMEBREW_DOWNLOAD_CONCURRENCY HOMEBREW_EDITOR HOMEBREW_FAIL_LOG_LINES HOMEBREW_FORBIDDEN_OWNER
#		 HOMEBREW_FORBID_PACKAGES_FROM_PATHS HOMEBREW_GIT_PATH HOMEBREW_INSTALL_BADGE HOMEBREW_LIVECHECK_WATCHLIST
#		 HOMEBREW_LOGS HOMEBREW_MAKE_JOBS HOMEBREW_NO_ANALYTICS HOMEBREW_NO_AUTO_UPDATE HOMEBREW_NO_COLOR
#		 HOMEBREW_NO_ENV_HINTS HOMEBREW_NO_INSTALL_CLEANUP HOMEBREW_NO_INSTALL_UPGRADE HOMEBREW_NO_UPDATE_REPORT_NEW
#		 HOMEBREW_PIP_INDEX_URL HOMEBREW_PREFIX HOMEBREW_REPOSITORY HOMEBREW_SSH_CONFIG_PATH HOMEBREW_SVN HOMEBREW_TEMP
#		 INFOPATH
#>
#/ Synopsis
